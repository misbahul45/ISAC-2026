...
<head>
    ...
    <title>Kode Verifikasi Email ISAC 2026</title>
</head>
                    ...
                    <tr>
                        <td style="background-color: #ffffff; padding: 40px;">
                            ...
                            <p style="margin: 0 0 32px; color: #64748b; font-size: 14px; line-height: 1.5;">
                                Gunakan kode berikut untuk memverifikasi email Anda. Jangan bagikan kode ini kepada siapa pun.
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 24px 40px; border-top: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;">
                            <p style="margin: 0 0 8px; color: #94a3b8; font-size: 13px; line-height: 1.5;">
                                Jika Anda tidak mendaftar di ISAC 2026, abaikan email ini.
                            </p>
...
<?php /**PATH C:\Dev\ISAC-2026\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>